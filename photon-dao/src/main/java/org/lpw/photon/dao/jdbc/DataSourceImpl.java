...
import org.lpw.photon.dao.dialect.DialectFactory;
...
public class DataSourceImpl implements org.lpw.photon.dao.jdbc.DataSource, ContextRefreshedListener {
    ...
    @Value("${photon.dao.database.initial-size:0}")
    private int initialSize;
    @Value("${photon.dao.database.max-active:5}")
    private int maxActive;
    @Value("${photon.dao.database.max-wait:5000}")
    private int maxWait;
    @Value("${photon.dao.database.test-interval:30000}")
    private int testInterval;
    @Value("${photon.dao.database.remove-abandoned-timeout:60}")
    private int removeAbandonedTimeout;
    @Value("${photon.dao.database.config:}")
