...
public class EngineImpl implements Engine, StorageListener {
    ...
    private static final byte[] READY = "photon.ready.execute();".getBytes();
    private static final String HAS_METHOD_NAME = "photon.existsMethod";
    ...
    @Value("${photon.script.path:/WEB-INF/script}")
    private String path;
